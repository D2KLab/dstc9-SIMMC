...
FLAGS = flags.FLAGS
flags.DEFINE_string(
    "action_json_path", "action_annotations/fashion_devtest_dials_api_calls.json", "Ground truth API calls"
)
flags.DEFINE_string(
    "model_output_path", "checkpoints/2020-08-07T10:57:57/eval_out.json", "Action API predictions by the model"
)
